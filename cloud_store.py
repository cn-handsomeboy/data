...
- 数据文件：data/cloud_feedback.json（反馈）、data/cloud_events.json（访问事件）
...
CLOUD_FEEDBACK_PATH = "data/cloud_feedback.json"
...
def _repo() -> str:
    return os.environ.get("GITHUB_REPO", _DEFAULT_REPO).strip() or _DEFAULT_REPO
